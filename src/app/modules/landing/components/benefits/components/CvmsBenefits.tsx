    ...
    <div className="py-10 px-6 md:px-8 w-full bg-[#FFF]">
      <div className="flex flex-col md:flex-row w-full max-w-full px-4 py-8 gap-8 bg-gray-100">
        ...
        <Card className="w-full md:w-1/2 border-0 shadow-md overflow-hidden">
          <CardHeader className="bg-[#2A9F47] text-black p-4">
            <CardTitle className="font-semibold text-lg">Benefits</CardTitle>
          </CardHeader>
          <CardContent className="bg-[#2A9F47] text-black p-6">
            <ul className="space-y-4">
              {benefits.map((benefit, index) => (
                <li key={index} className="flex items-center">
                  <span className="h-5 w-5 bg-black rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                    <svg
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-6">
          ...
          <Card className="border-0 shadow-md overflow-hidden">
            <CardHeader className="bg-[#F2F2F7] p-4">
          ...
          {/* Vision Card */}
          <Card className="border-0 shadow-md overflow-hidden">
            <CardHeader className="bg-[#000000] text-white p-4">
