  ...
  const handleDownloadCertificate = async (vin: string) => {
    try {
      ...
      const certificateData = {
        ...
        certificateNumber: vehicleRecord.cert_num || '',
        ownerName: userData.fullName,
        ownerAddress: userData.address || "No 16B Alimini Street Ipaja", // Use fallback address if needed
        date: new Date().toLocaleDateString('en-GB', { 
          day: '2-digit', 
          month: 'short', 
          year: 'numeric' 
        }),
        qrCodeBase64: vehicleRecord.qr_code_base64 || '' // Use the QR code from API if available
      };
